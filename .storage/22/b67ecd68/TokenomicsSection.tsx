  ...
  const tokenomics = [
    {
      ...
      description: 'Funding technology, servers, AI, smart contracts',
    ...
    },
    {
      ...
      description: 'Contests, challenges, Rewards in Meme-to-Earn',
    ...
    },
    {
      ...
      description: 'Expanding global community base',
    ...
    },
    {
      ...
      description: 'Salaries and incentives for the American team',
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">
            Transparent and fair distribution of 400 billion CPM through audited Smart Contracts
          </p>
        ...
        >
          <h3 className="text-2xl font-bold text-center mb-8">Visual Distribution</h3>
        ...
        >
          {[
            { title: 'Full Transparency', description: 'All transactions on blockchain' },
            { title: 'CertiK Audited', description: 'Smart contracts audited by top firms' },
            { title: 'Fair Distribution', description: 'No hidden or fraudulent allocations' },
          ].map((feature, i) => (
