        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              ...
              <span className="text-sm font-semibold">محرك الضخّ الذكي</span>
            </motion.div>
            ...
            <p className="text-xl lg:text-2xl mb-4 text-purple-300 font-bold">
              ثورة الميمز التي تفكر قبل أن تضخّ
            </p>

            <p className="text-lg mb-8 text-gray-300 max-w-2xl mx-auto lg:mr-0">
              ليست مجرد عملة ميم، إنها محرك "الضخّ الجماعي الذكي" الذي يوحّد قوة الميمز، الذكاء الاصطناعي، والبلوكشين لإنشاء موجات ضخّ رقمية مدعومة بالبيانات والمجتمع.
            </p>
            ...
            >
              <div className="glass-effect p-4 rounded-lg">
                ...
                <div className="text-sm text-gray-400">إجمالي العرض</div>
              </div>
              <div className="glass-effect p-4 rounded-lg">
                <div className="text-3xl font-black gradient-text">5</div>
                <div className="text-sm text-gray-400">منصات متكاملة</div>
              </div>
              <div className="glass-effect p-4 rounded-lg">
                <div className="text-3xl font-black gradient-text">AI</div>
                <div className="text-sm text-gray-400">مدعوم بالذكاء</div>
              </div>
            </motion.div>
          </motion.div>
