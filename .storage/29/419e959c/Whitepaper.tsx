...
function WhitepaperSection({ section, index }: { section: any; index: number }) {
        ...
        <CardContent className="space-y-6">
          ...
          {section.utilities && (
            <div className="space-y-4 mt-6">
              {section.utilities.map((utility: any, i: number) => (
          ...
          {section.tokenomics && (
            <div className="space-y-4 mt-6">
              ...
              {section.tokenomics.map((item: any, i: number) => (
                <div key={i} className="glass-effect p-6 rounded-lg">
          ...
          {section.team && (
            <div className="grid md:grid-cols-2 gap-4 mt-6">
              {section.team.map((member: any, i: number) => (
                <div key={i} className="glass-effect p-6 rounded-lg">
          ...
          {section.roadmap && (
            <div className="space-y-4 mt-6">
              {section.roadmap.map((item: any, i: number) => (
