  ...
  const roadmap = [
    {
      ...
      icon: Rocket,
      items: [
        'Launch smart contracts on BASE & ETH',
        'Launch official website and platforms',
    ...
    {
      quarter: 'Q2 2025',
      title: 'Expansion & Airdrop',
      icon: Zap,
      items: [
        'Launch massive global Airdrop',
        'First collective Pump Event',
        'Launch Meme-to-Earn platform',
    ...
    },
    {
      ...
      icon: Brain,
      items: [
        'Launch CPM AI Pump Engine',
        'Launch NFT Meme Arsenal',
        'Launch DeFi Pump Hub',
        'CertiK audit of smart contracts',
      ],
    ...
    {
      quarter: 'Q4 2025',
      title: 'Metaverse & Global Expansion',
      icon: Globe,
      items: [
        'Launch CPM VR World',
        'Virtual pump events in metaverse',
        'Expand to global exchanges',
        'Strategic partnerships with Web3 companies',
      ],
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            An ambitious journey towards building the world's first smart Meme Pump system
          </p>
        </motion.div>

        <div className="relative">
          {/* Timeline Line */}
          <div className="hidden lg:block absolute left-1/2 top-0 bottom-0 w-1 bg-gradient-to-b from-purple-500 via-blue-500 to-green-500" />
        ...
        >
          <h3 className="text-3xl font-black mb-4 gradient-text">Future Vision</h3>
          <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
            We aim to make CPM the global standard for smart memes, where technology meets popular culture to create a new digital economy based on creativity and community
          </p>
        </motion.div>
      </div>
    </section>
